...
import withHost, { InjectedProps, WrappedComponentProps } from '@coreai/ui/hoc/withHost';
...
const ImageGenerator: React.FC<WrappedComponentProps & InjectedProps> = (props) => {
...
export default withHost(ImageGenerator);